...
"Summarize the following text. Do not include any personal opinions. The text is: 'The quick brown fox jumps over the lazy dog. This is a classic sentence...'"
...
**Text to summarize:**
'''
The quick brown fox jumps over the lazy dog. This is a classic sentence used for typing practice, containing every letter of the alphabet. It is often used to test typewriters or keyboards.
'''
"
